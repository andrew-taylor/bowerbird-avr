...
USB_Descriptor_Configuration_t ConfigurationDescriptor PROGMEM =
  { Config:
    ...
    { Header:			{ Size: sizeof(USB_AudioFeatureUnit_t),
      ...
      MasterControls:           0, //FEATURE_VOLUME, // FEATURE_VOLUME, // FIXME master, applies to all channels.
      ChannelControls:          { FEATURE_VOLUME, FEATURE_VOLUME }, // FIXME per-channel controls, one entry per channel
    ...
    { Header:                   {Size: sizeof(USB_AudioFormat_t), Type: DTYPE_AudioInterface},
      ...
      BitResolution:            16, // FIXME We use 12 bits of the 2 bytes
